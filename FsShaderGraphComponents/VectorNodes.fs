...
[<AbstractClass>]
type VectorMathBaseNode(optype, openum, category, subcategory, outputdescription, op) =
  inherit CyclesNode(
...
type VectorMathAdd() =
  inherit VectorMathBaseNode(typeof<ccl.ShaderNodes.VectorAdd>, VectorMathNode.Operations.Add, "Shader", "Vector", "Vector1+Vector2", (+))
...
type VectorMathSubtract() =
  inherit VectorMathBaseNode(typeof<ccl.ShaderNodes.VectorSubtract>, VectorMathNode.Operations.Subtract, "Shader", "Vector", "Vector1-Vector2", (+))
...
type VectorMathAverage() =
  inherit VectorMathBaseNode(typeof<ccl.ShaderNodes.VectorAverage>, VectorMathNode.Operations.Average, "Shader", "Vector", "NormLen(Vector1+Vector2)", (+))
  override u.ComponentGuid = u |> ignore; new Guid("000d564f-85c7-409f-b4fc-ae0c1152a19e")
  override u.Icon = u |> ignore; Icons.Add

type VectorMathDot() =
  inherit VectorMathBaseNode(typeof<ccl.ShaderNodes.VectorDot_Product>, VectorMathNode.Operations.Dot_Product, "Shader", "Vector", "Fac = Dot(Vector1,Vector2)", (+))
...
type VectorMathCross() =
  inherit VectorMathBaseNode(typeof<ccl.ShaderNodes.VectorCross_Product>, VectorMathNode.Operations.Cross_Product, "Shader", "Vector", "NormLen(Cross(Vector1,Vector2))", (+))
